execute store result storage geegaz:gghe temp.CookingPot.Level int 1.0 run scoreboard players get @s gghe.level
...
execute as @s[scores={gghe.level=1..}] run data modify storage geegaz:gghe temp.CustomModelData set value 1707103
