...
execute as @s[tag=!gghe.cooking_pot.has_water] if score $gghe.ingredient_1 gghe.var matches 1 if score $gghe.ingredient_2 gghe.var matches 2 run data modify storage geegaz:gghe temp.CookingPot.Recipe set value {id:"gghe:roast_chicken",Servings:2,Duration:400}