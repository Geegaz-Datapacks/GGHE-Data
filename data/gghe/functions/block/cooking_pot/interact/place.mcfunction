...
execute if entity @p[tag=gghe.interact.cooking_pot,predicate=gghe:is_sneaking] run tag @s add gghe.remove_all
...
execute as @s[predicate=gghe:item/bowl,tag=!gghe.interact_fail,tag=!gghe.remove_all] run function gghe:block/cooking_pot/interact/bowl/test
execute as @s[predicate=gghe:item/any_bucket,tag=!gghe.interact_fail,tag=!gghe.remove_all] run function gghe:block/cooking_pot/interact/water/test
execute as @s[predicate=gghe:tag/ingredients,tag=!gghe.interact_fail,tag=!gghe.remove_all] run function gghe:block/cooking_pot/interact/ingredient/test
# Update recipe
execute as @s[tag=!gghe.interact_fail] run function gghe:block/cooking_pot/interact/recipe/test
execute as @s[tag=gghe.interact_fail,tag=gghe.remove_all] run function gghe:block/cooking_pot/interact/recipe/test
