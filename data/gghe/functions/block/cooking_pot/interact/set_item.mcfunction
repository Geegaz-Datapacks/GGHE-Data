...
loot replace entity @p[tag=gghe.interact.cooking_pot] weapon.mainhand loot gghe:cooking_pot/item
execute unless entity @p[tag=gghe.interact.cooking_pot] run loot spawn ~ ~0.5 ~ loot gghe:cooking_pot/item
