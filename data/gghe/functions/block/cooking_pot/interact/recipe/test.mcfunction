...
#scoreboard players operation @e[type=armor_stand,tag=gghe.cooking_pot.ingredient_provider] gghe.items = @s gghe.items
...
execute as @s[scores={gghe.items=1}] run function #gghe:cooking_pot/recipes_1
execute as @s[scores={gghe.items=2}] run function #gghe:cooking_pot/recipes_2
execute as @s[scores={gghe.items=3}] run function #gghe:cooking_pot/recipes_3
execute as @s[scores={gghe.items=4}] run function #gghe:cooking_pot/recipes_4
