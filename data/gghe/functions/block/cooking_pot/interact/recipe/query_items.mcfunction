...
execute if score $gghe.items gghe.var matches 1.. run function gghe:block/cooking_pot/interact/recipe/test_item
...
# Loop if there are still items to test
execute if data storage geegaz:gghe temp.CookingPot.Items[] run function gghe:block/cooking_pot/interact/recipe/query_items