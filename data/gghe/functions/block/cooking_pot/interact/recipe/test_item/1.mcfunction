...
data modify storage geegaz:gghe temp.Item.B set from storage geegaz:gghe temp.Items[1]
...
execute as @s[scores={gghe.var=0}] store result storage geegaz:gghe temp.Items[1].Count byte -1.0 run data get storage geegaz:gghe temp.Items[1].Count -1.0001
